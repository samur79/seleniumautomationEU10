...
public class T1_WebTable_Order_Verify {
    ...
    public void order_name_verify_test(){
        ...
        // the xpath below can get the Bob Martin as well it gives the location of the cell.
        // When another order comes the place of martin might change so above one is a better solution.
        driver.findElement(By.xpath("//*[@id=\"ctl00_MainContent_orderGrid\"]/tbody/tr[7]/td[2]"));
